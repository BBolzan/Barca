...
public class BarcaBugs {
    public final int ASSENTOS_POR_FILA = 20;
    public final int FILAS = 60;
    ...
    public int ocupaLugar(String assentoInformado) {
        ...
        if (Pattern.matches("[F][0-9]{2}[A][0-9]{2}", assentoInformado) == false) {
            // O bug ai é que o intervalo ali de cima é com 9 ao invéz de 8
            return 0;
        }
    ...
    public int getQt() {
        return this.qtdadeAssentosOcupados;
    }
}
